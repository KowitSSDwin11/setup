...
cd ~/android/lineage
echo "Initializing the LOS source repository"
...
git clone --depth 1 https://github.com/voidanix/android_kernel_motorola_msm8226 -b lineage-17.1 kernel/motorola/msm8226
