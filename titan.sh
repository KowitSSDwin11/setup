...
git clone https://github.com/RenanQueiroz/android_device_motorola_titan --depth 1 -b lineage-17.1 device/motorola/titan
echo "Cloning device kernel"
git clone https://github.com/RenanQueiroz/android_kernel_motorola_msm8226 --depth 1 -b lineage-17.0 kernel/motorola/msm8226
echo "Cloning device vendor"
git clone https://github.com/RenanQueiroz/proprietary_vendor_motorola --depth 1 -b lineage-16.0 vendor/motorola
echo "Cloning device common"
git clone https://github.com/MotoDevelopment/android_device_motorola_msm8226-common --depth 1 -b lineage-17.1 device/motorola/msm8226-common
echo "Cloning qcom"
